...
#include "Graph.h"
//g++ drill13.cpp Graph.cpp Window.cpp GUI.cpp Simple_window.cpp -o drill12   `fltk-config --ldflags --use-images`
// A drill-t a GUI mappaban irtam, szoval nem biztos, hogy jok az include-ok
